...
const items: SocialItem[] = [
  {
    id: "github",
    label: "GitHub",
    href: "https://github.com/TanishAdke",
    icon: (
  ...
  },
  {
    id: "linkedin",
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/tanish-adke-6132992b7?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    icon: (
      <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current" aria-hidden="true">
  ...
  
  {
    id: "instagram",
    label: "Instagram",
    href: "https://www.instagram.com/tanish_adke_5925?igsh=d2p0eTJzdzJ0dGZi",
    icon: (
      <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current" aria-hidden="true">
